...
- Админка пользователей теперь использует штатный Django `UserAdmin`, поэтому новые пароли сохраняются только в виде хеша.
- Добавлена миграция, которая хеширует уже сохранённые plaintext-пароли пользователей, созданных через старую форму админки.
