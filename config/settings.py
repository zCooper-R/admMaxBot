...
SECURE_SSL_REDIRECT = env("SECURITY_SSL_REDIRECT")
SESSION_COOKIE_SECURE = env("SECURITY_SESSION_COOKIE_SECURE")
CSRF_COOKIE_SECURE = env("SECURITY_CSRF_COOKIE_SECURE")
SECURE_HSTS_SECONDS = env("SECURITY_HSTS_SECONDS")
SECURE_HSTS_INCLUDE_SUBDOMAINS = env("SECURITY_HSTS_INCLUDE_SUBDOMAINS")
SECURE_HSTS_PRELOAD = env("SECURITY_HSTS_PRELOAD")
